...
<script>
    function validateTelefono(input) {
        ...
        // Verificar si el valor contiene solo n��meros y tiene un m��ximo de 10 d��gitos
        if (!(/^\d{0,10}$/).test(telefonoNumeros)) {
            input.setCustomValidity('El tel��fono debe contener solo n��meros y tener m��ximo 10 d��gitos.');
        } else {
