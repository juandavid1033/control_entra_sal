...
$sql1 = $conex->prepare("SELECT usuario.*, estados.id_estados, estados.nom_estado FROM usuario LEFT JOIN estados ON usuario.id_estados = estados.id_estados WHERE id_rol = 2 ORDER BY documento LIMIT $empieza, $por_pagina");
$sql1->execute();
$resultado1 = $sql1->fetchAll(PDO::FETCH_ASSOC);

// Contar el número total de registros
$total_registros = $conex->query("SELECT COUNT(*) FROM usuario WHERE id_rol = 2")->fetchColumn();
