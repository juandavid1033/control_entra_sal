...
$control->execute();
$query = $control->rowCount(); // Cambio aquí
...
if (isset($_POST["validar_V"])) {
    ...
    $insertsql = $conex->prepare("INSERT INTO tipo_vehiculo (nom_vehiculo) VALUES (?)");
    $insertsql->execute([$tipo_vehiculo]);    
                    ...
                    <div class="col-lg-20">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 mb-4">Crear Tipo Vehiculo</h1>
                            </div>
                            <form method="post" autocomplete="off" name="cli" enctype="multipart/form-data">
                                <div class="col-sm-20 mb-7 mb-sm-2">
                                    <label>Tipo Vehiculo</label>
                                    <input type="text" class="form-control form-control-lg form-control-user w-100" id="tipo_dispositivo" name="tipo_vehiculo" placeholder="Ingresa tipo vehiculo" required maxlength="16" onkeypress="return sololetras(event)">
                                    <small id="tipo_vehiculoHelp" class="form-text text-danger"></small>
                                </div>
