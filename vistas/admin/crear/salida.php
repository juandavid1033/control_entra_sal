...
<body>
    ...
    <br>
    <a class="btn btn success" href="../tablas/exportar_excel.php" style="margin-left: 90%; margin-top:0%;">
        ...
        <a class="btn btn success" href="../tablas/exportar_pdf.php" style="margin-left: 88%; margin-top:1%;">
